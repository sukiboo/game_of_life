...
class SmoothingOptimization:
    '''Setup a smoothing-based optimization'''

    def __init__(self, learning_rate=1e-3, sigma=.1, num_quad=5):
    ...
    def train(self, model, training_data, test_data=None, epochs=100):
        ...
        for _ in pbar:
            ...
            self.weights = self.array_to_weights(weights_array - self.learning_rate * np.matmul(dg, u))
